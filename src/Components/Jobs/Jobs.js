  ...
  return (
    <>
      <div className="  container mx-auto">
        <p className=" text-center text-black text-3xl aluniBackground py-20 font-bold galdenoFont">
          Jobs List
        </p>
        <div className=" text-center my-3">
          <label htmlFor="my-modal-6" className="btn btn-outline modal-button">
