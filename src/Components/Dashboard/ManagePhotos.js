                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className=' flex items-center '>
                        <div className="form-control w-full max-w-xs">
                            ...
                            <input className="input input-bordered text-black w-full max-w-xs rounded-lg" placeholder="Your Reg Number" type="file" {...register("photo", {
                                required: {
                                    value: true,
                                ...
                                <tr key={photo?._id}>
                                    ...
                                    <td>
                                        <div className="flex items-center space-x-3">
                                            <div>
                                                <img className=' rounded-xl' style={{ width: '150px', height: '100px' }} src={photo?.photoUrl} alt='Tejgaon College Pic' />
                                            </div>
                                        </div>
                                    </td>
                                    <th>
